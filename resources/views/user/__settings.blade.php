                            ...
                            <div class="dashboardBoxBg mb30">
                                <div class="profileImage center-block">
                                    <select name="avatar" id="avatarmenu">
                                        <option value="1" title="{{ asset('img/dashboard/' . $user->meta['gender'] . '/1.png') }}"></option>
                                        <option value="2" title="{{ asset('img/dashboard/' . $user->meta['gender'] . '/2.png') }}"></option>
                                        <option value="3" title="{{ asset('img/dashboard/' . $user->meta['gender'] . '/3.png') }}"></option>
                                        <option value="4" title="{{ asset('img/dashboard/' . $user->meta['gender'] . '/4.png') }}"></option>
                                        <option value="5" title="{{ asset('img/dashboard/' . $user->meta['gender'] . '/5.png') }}"></option>
                                    </select>
                                </div>
