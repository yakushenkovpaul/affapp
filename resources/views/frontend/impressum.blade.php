                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <ul class="list-unstyled termsList">
                            ...
                            <li>
                                <h3>Kontakt</h3>
                                <p><a href="contact.html">Kontaktformular</a></p>
                            </li>
                            <li>
                                <p>Anfragen werden ausschließlich über das Kontaktformular bearbeitet, wir bieten keinen Telefonsupport. Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung bereit. Die Plattform finden Sie unter http://ec.europa.eu/consumers/odr/
                                    Registergericht:
